...
const _sfc_main = /* @__PURE__ */ vue.defineComponent({
  ...
  setup(__props, { emit }) {
    ...
    const request = vue.ref(new main.UpdateBooking());
    vue.watchEffect(async () => {
      var _a;
      const api = await client.api(new main.QueryBookings({ id: props.id }));
      if (api.succeeded) {
        request.value = new main.UpdateBooking(utils.sanitizeForUi((_a = api.response) == null ? void 0 : _a.results[0]));
      }
    });
    const onDelete = async () => {
      const api = await client.apiVoid(new main.DeleteBooking({ id: props.id }));
      if (api.succeeded)
        close();
    };
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_ConfirmDelete = vue.resolveComponent("ConfirmDelete");
      ...
      _push(serverRenderer.ssrRenderComponent(_component_ConfirmDelete, { onDelete }, {
      ...
      _push(`</div>`);
      _push(serverRenderer.ssrRenderComponent(SrcLink.__unplugin_components_2, { href: "https://github.com/NetCoreTemplates/vue-ssg/blob/main/ui/src/pages/bookings-crud/Edit.vue" }, {
        default: vue.withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
      ...
      _push(serverRenderer.ssrRenderComponent(_component_PrimaryButton, null, {
        default: vue.withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            return [
              vue.createTextVNode("Update Booking")
            ];
          }
        }),
        _: 1
...
const Edit = /* @__PURE__ */ main._export_sfc(_sfc_main, [["__file", "C:/Users/mark.greenway/Desktop/Repos/yyy_trash/Lisa/ui/src/pages/bookings-crud/Edit.vue"]]);
