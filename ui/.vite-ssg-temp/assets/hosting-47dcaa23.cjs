...
const __unplugin_components_1 = { name: "logos-jamstack-icon", render };
const title = "App Hosting Costs";
const meta = [{ "property": "og:title", "content": "App Hosting Costs" }];
const _sfc_main = {
  __name: "hosting",
  ...
  setup(__props, { expose }) {
    ...
    expose({ frontmatter });
    const head$1 = { "title": "App Hosting Costs", "meta": [{ "property": "og:title", "content": "App Hosting Costs" }] };
    head.useHead(head$1);
    return (_ctx, _push, _parent, _attrs) => {
      const _component_MarkdownPage = MarkdownPage.__unplugin_components_0;
      const _component_LogosJamstackIcon = __unplugin_components_1;
      const _component_EmojioneMoneyWithWings = __unplugin_components_2;
      const _component_LogosDigitalOcean = __unplugin_components_3;
      _push(serverRenderer.ssrRenderComponent(_component_MarkdownPage, vue.mergeProps({ frontmatter }, _attrs), {
        default: vue.withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(serverRenderer.ssrRenderComponent(_component_LogosJamstackIcon, { class: "w-14 h-14 float-left mt-2 mr-4" }, null, _parent2, _scopeId));
            ...
            _push2(serverRenderer.ssrRenderComponent(_component_EmojioneMoneyWithWings, { class: "w-14 h-14 float-left mt-2 mr-4" }, null, _parent2, _scopeId));
            ...
            _push2(serverRenderer.ssrRenderComponent(_component_LogosDigitalOcean, { class: "w-24 h-24 float-left mt-0 mr-8" }, null, _parent2, _scopeId));
            ...
            return [
              vue.createVNode("div", { class: "markdown-body" }, [
                vue.createVNode("a", { href: "https://jamstack.org" }, [
                  vue.createVNode(_component_LogosJamstackIcon, { class: "w-14 h-14 float-left mt-2 mr-4" })
                ]),
                vue.createVNode("p", null, [
                  vue.createTextVNode("The modern "),
                  vue.createVNode("a", { href: "https://jamstack.org" }, "jamstack.org"),
                  vue.createTextVNode(" approach for developing websites is primarily concerned with adopting the architecture yielding the best performance and superior UX by minimizing the time to first byte from serving pre-built static assets from CDN edge caches.")
                ]),
                vue.createVNode("h2", null, "Cheaper Hosting"),
                vue.createVNode("a", { href: "https://jamstack.org" }, [
                  vue.createVNode(_component_EmojioneMoneyWithWings, { class: "w-14 h-14 float-left mt-2 mr-4" })
                ]),
                vue.createVNode("p", null, "A consequence of designing your UI decoupled from your back-end server is that it also becomes considerably cheaper to host as its static files can be hosted by any web server and is a task highly optimized by CDNs who are able to provide generous free & low cost hosting options."),
                vue.createVNode("h2", null, [
                  vue.createVNode("a", { href: "https://github.com/NetCoreTemplates/vue-ssg/tree/main/ui" }, "/ui")
                ]),
                vue.createVNode("p", null, [
                  vue.createTextVNode("This template takes advantage of its decoupled architecture and uses "),
                  vue.createVNode("a", { href: "/posts/deploy" }, "GitHub Actions to deploy"),
                  vue.createTextVNode(" a copy of its static UI generated assets and hosted on:")
                ]),
                vue.createVNode("h3", null, "GitHub Pages CDN"),
                vue.createVNode("h3", null, [
                  vue.createVNode("a", { href: "https://vue-ssg.jamstacks.net" }, "vue-ssg.jamstacks.net")
                ]),
                vue.createVNode("p", null, [
                  vue.createTextVNode("This is an optional deployment step which publishes a copy of your .NET App’s "),
                  vue.createVNode("code", null, "/wwwroot"),
                  vue.createTextVNode(" folder to this templates "),
                  vue.createVNode("a", { href: "https://github.com/NetCoreTemplates/vue-ssg/tree/gh-pages" }, "gh-pages"),
                  vue.createTextVNode(" branch where it’s automatically served from "),
                  vue.createVNode("a", { href: "https://docs.github.com/en/pages/getting-started-with-github-pages/about-github-pages" }, "GitHub Pages CDN"),
                  vue.createTextVNode(" at "),
                  vue.createVNode("strong", null, "no cost"),
                  vue.createTextVNode(".")
                ]),
                vue.createVNode("p", null, "It’s an optional but recommended optimization as it allows the initial download from your website to be served directly from CDN edge caches."),
                vue.createVNode("h2", null, [
                  vue.createVNode("a", { href: "https://github.com/NetCoreTemplates/vue-ssg/tree/main/api" }, "/api")
                ]),
                vue.createVNode("p", null, [
                  vue.createTextVNode("The .NET 6 "),
                  vue.createVNode("code", null, "/api"),
                  vue.createTextVNode(" backend server is required for this App’s dynamic functions including the Hello API on the home page and its "),
                  vue.createVNode("a", { href: "https://docs.servicestack.net/auth" }, "built-in Authentication"),
                  vue.createTextVNode(".")
                ]),
                vue.createVNode("p", null, "The C# project still contains the complete App and can be hosted independently with the entire App served directly from its deployed ASP.NET Core server at:"),
                vue.createVNode("h3", null, "Digital Ocean"),
                vue.createVNode("h3", null, [
                  vue.createVNode("a", { href: "https://vue-ssg-api.jamstacks.net" }, "vue-ssg-api.jamstacks.net")
                ]),
                vue.createVNode("p", null, [
                  vue.createTextVNode("But when accessed from the CDN "),
                  vue.createVNode("a", { href: "https://vue-ssg.jamstacks.net" }, "vue-ssg.jamstacks.net"),
                  vue.createTextVNode(" that contains a copy of its static "),
                  vue.createVNode("code", null, "/wwwroot"),
                  vue.createTextVNode(" UI assets, only its back-end JSON APIs are used to power its dynamic features.")
                ]),
                vue.createVNode("h2", null, "Total Cost"),
                vue.createVNode("a", { href: "https://www.digitalocean.com/pricing" }, [
                  vue.createVNode(_component_LogosDigitalOcean, { class: "w-24 h-24 float-left mt-0 mr-8" })
                ]),
                vue.createVNode("p", null, [
                  vue.createTextVNode("Since hosting on GitHub Pages CDN is free, the only cost is for hosting this App’s .NET Server which is being hosted from a basic "),
                  vue.createVNode("a", { href: "https://www.digitalocean.com/pricing" }, "$10 /mo"),
                  vue.createTextVNode(" droplet which is currently hosting "),
                  vue.createVNode("strong", null, "25"),
                  vue.createTextVNode(" .NET Docker Apps and demos of "),
                  vue.createVNode("a", { href: "https://servicestack.net/start" }, "starting project templates"),
                  vue.createTextVNode(" which works out to be just under "),
                  vue.createVNode("strong", null, "0.40 /mo"),
                  vue.createTextVNode("!")
                ]),
                vue.createVNode("h2", null, "Jamstack Benefits"),
                vue.createVNode("p", null, [
                  vue.createTextVNode("Jamstack is quickly becoming the preferred architecture for the development of modern web apps with "),
                  vue.createVNode("a", { href: "https://jamstack.org/why-jamstack/" }, "benefits"),
                  vue.createTextVNode(" that extend beyond performance to improved:")
                ]),
                vue.createVNode("ul", null, [
                  vue.createVNode("li", null, [
                    vue.createVNode("strong", null, "Security"),
                    vue.createTextVNode(" from a reduced attack surface from hosting read-only static resources and requiring fewer App Servers")
                  ]),
                  vue.createVNode("li", null, [
                    vue.createVNode("strong", null, "Scale"),
                    vue.createTextVNode(" with non-essential load removed from App Servers to CDN’s architecture capable of incredible scale & load capacity")
                  ]),
                  vue.createVNode("li", null, [
                    vue.createVNode("strong", null, "Maintainability"),
                    vue.createTextVNode(" resulting from reduced hosting complexity and the clean decoupling of UI and server logic")
                  ]),
                  vue.createVNode("li", null, [
                    vue.createVNode("strong", null, "Portability"),
                    vue.createTextVNode(" with your static UI assets being easily capable from being deployed and generically hosted from any CDN or web server")
                  ]),
                  vue.createVNode("li", null, [
                    vue.createVNode("strong", null, "Developer Experience"),
                    vue.createTextVNode(" with the major JavaScript frameworks at the forefront of amazing DX are embracing Jamstack in their dev model, libraries & tooling")
                  ])
                ]),
                vue.createVNode("p", null, [
                  vue.createTextVNode("Best of all the Jamstack approach fits perfectly with ServiceStack’s recommended "),
                  vue.createVNode("a", { href: "https://docs.servicestack.net/api-first-development" }, "API First Development"),
                  vue.createTextVNode(" model which encourages development of reusable message-based APIs where the same System APIs can be reused from all Web, Mobile & Desktop Apps from multiple HTTP, MQ or gRPC endpoints.")
                ])
              ])
            ];
          }
...
const hosting = /* @__PURE__ */ main._export_sfc(_sfc_main, [["__file", "C:/Users/mark.greenway/Desktop/Repos/yyy_trash/Lisa/ui/src/pages/hosting.md"]]);
